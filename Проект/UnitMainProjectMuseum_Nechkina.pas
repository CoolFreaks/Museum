...
type
  TFormMain = class(TForm)
    ...
    UniDataSourceGuide: TUniDataSource;
    UniQueryPetrov: TUniQuery;
    UniQueryEdyard: TUniQuery;
    UniQueryAlex: TUniQuery;
    LabelNamePetrov: TLabel;
    LabelNameEdyard: TLabel;
    LabelNameAlex: TLabel;
    DBEditGuideHelloName: TDBEdit;
    DBEditGuideHelloData: TDBEdit;
    DBEditGuideHelloHall: TDBEdit;
    DBEditGuideHelloID: TDBEdit;
...
begin
  ...
  if (EditLogin.Text = 'Petrovexc') and (EditPassword.Text = 'Petrovexc2') then
    begin
      flag:=1;
      NotebookMain.ActivePage := 'GuideHello';
      LabelNamePetrov.Visible := true;
      LabelNameEdyard.Visible := false;
      LabelNameAlex.Visible := false;
      UniDataSourceGuide.DataSet := UniQueryPetrov;
      EditLogin.Text := '';
      EditPassword.Text := '';
      EditCodeAdmin.Text := '';
    end;
    
  if (EditLogin.Text = 'Edyardexc') and (EditPassword.Text = 'Edyardexc6') then
    begin
      flag:=1;
      NotebookMain.ActivePage := 'GuideHello';
      LabelNamePetrov.Visible := false;
      LabelNameEdyard.Visible := true;
      LabelNameAlex.Visible := false;
      UniDataSourceGuide.DataSet := UniQueryEdyard;
      EditLogin.Text := '';
      EditPassword.Text := '';
      EditCodeAdmin.Text := '';
    end;

  if (EditLogin.Text = 'Alexexc') and (EditPassword.Text = 'Alexexc7') then
    begin
      flag:=1;
      NotebookMain.ActivePage := 'GuideHello';
      LabelNamePetrov.Visible := false;
      LabelNameEdyard.Visible := false;
      LabelNameAlex.Visible := true;
      UniDataSourceGuide.DataSet := UniQueryAlex;
      EditLogin.Text := '';
      EditPassword.Text := '';
      EditCodeAdmin.Text := '';
    end;
